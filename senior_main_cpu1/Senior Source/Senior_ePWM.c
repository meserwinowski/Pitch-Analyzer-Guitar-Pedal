...
void initEPWM(void) {
    ...
    EPwm1Regs.TBCTR = 0x0000;               // Clear Timer Counter Register
    EPwm1Regs.TBPRD = ADC_SAMPLE_PERIOD;    // Set Time Base Period Register
    EPwm1Regs.TBPHS.bit.TBPHS = 0x0000;     // Set Time Base Phase High Register
    ...
    EPwm1Regs.TBCTL.bit.CTRMODE = 0x0;      // Enable timer to count up
    ...
    CpuSysRegs.PCLKCR0.bit.TBCLKSYNC = 1; // Enable ePWM Peripheral Clock
    EDIS;
}
